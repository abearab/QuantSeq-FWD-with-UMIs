...
### `sampleTable` for htseq-count: a data.frame with three or more columns stored in tablePATH
# Each row describes one sample. 
# 1st: The first column is the sample name, 
# 2ed: the second column the file name of the count file generated by htseq-count in countDIR, 
